...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32H5_ETHERNET_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32H5_PINCTRL_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ICACHE_LINE_SIZE, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_XWING_DUMBER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_XWING_DUMBER_STM32H563XX, 1);
